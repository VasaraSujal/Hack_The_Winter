...
/**
 * BloodBankNgoDriveController
 * Handles blood donation drives organized by NGOs with Blood Bank support
 */
...
export const completeDrive = async (req, res) => {
  try {
    ...
    // Update blood bank stock with collected blood
    const drive = await BloodBankNgoDrive.findById(id);
    if (drive && drive.bloodBankId) {
      // Add collected units to blood bank stock
