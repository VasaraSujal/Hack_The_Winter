  ...
  const SidebarContent = () => (
    <>
      <div>
        ...
        <h1 className="mt-3 text-3xl font-semibold">NGO Command</h1>
            ...
            <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex flex-wrap gap-3">
                <div className="rounded-3xl border border-pink-100 bg-white px-6 py-4 text-sm text-[#7c4a5e] shadow-[0_12px_30px_rgba(255,122,149,0.18)]">
                  ...
                  <p className="mt-2 text-3xl font-semibold text-[#31101e]">
                    {expectedActualRatio}%
                  </p>
                ...
                <a
                  ...
                  className="flex items-center gap-2 rounded-full border border-[#ffd6df] bg-white/85 px-6 py-3 text-sm font-semibold text-[#9b1e27] shadow-[0_12px_28px_rgba(155,30,39,0.18)] transition hover:bg-white"
                >
                  <span className="text-xs uppercase tracking-[0.4em] text-[#ff4d6d]">
                    Hotline
                  </span>
          ...
          <main className="flex-1 px-4 py-8 md:px-10">
            <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
              {heroStats.map((card) => (
                <article
                  key={card.label}
                  className="rounded-3xl border border-[#ffe0e8] bg-white px-5 py-4 shadow-[0_20px_45px_rgba(255,122,149,0.12)]"
                >
                  ...
                  <p className="text-xs text-[#a44255]">{card.label}</p>
                </article>
              ))}
            </section>
